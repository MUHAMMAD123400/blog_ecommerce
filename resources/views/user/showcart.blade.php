...
<html lang="en">
  ...
  <head>
    ...
    <!-- Bootstrap core CSS -->
    <link href=" {{asset('front_end/vendor/bootstrap/css/bootstrap.css')}}" rel="stylesheet">
<!--
...
-->
    ...
    <link rel="stylesheet" href=" {{asset('front_end/assets/css/templatemo-sixteen.css')}}">
            ...
            <ul class="navbar-nav ml-auto">
              ...
              <li class="nav-item">
                @if (Route::has('login'))
                    @auth
                    <li class="nav-item">
                      <a class="nav-link" href="{{url('showcart')}}"><i class="fa fa-cart-plus mr-2" aria-hidden="true"></i>Cart{{$count}}</a>
                    </li>
                    <x-app-layout>
  ...
  @endif
    ...
    <div style="padding: 100px;" class="d-flex justify-content-center">
